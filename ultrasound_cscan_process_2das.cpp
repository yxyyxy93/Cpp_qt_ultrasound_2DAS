...
ultrasound_cscan_process_2DAS::ultrasound_cscan_process_2DAS(QWidget *parent,
    ...
    QLabel *label1 = new QLabel("2D Analytic-signal analysis (please do it after aligning the surface)");
    ultrasound_Cscan_process::layout->addWidget(label1);
    QPushButton *button1 = new QPushButton("Go to 2D Analytic-signal analysis");
    ...
    // reserved for debug!
    //    // add a button to calculate the 2D AS
    //    // ************** create the push buttons and correponding labels
    //    QPushButton* myButton_2DAS_oneslice = new QPushButton(tr("Plot 2D analytic-signal images"), this);
    //    this->layout2->addWidget(myButton_2DAS_oneslice);
    //    connect(myButton_2DAS_oneslice, &QPushButton::clicked, this,
    //            &ultrasound_cscan_process_2DAS::handleButton_2DAS_oneslice);
}
...
void ultrasound_cscan_process_2DAS::handleButton_2DAS() {
    ...
    // Qcustomplot
    this->scrollBarZ_page2 = new QScrollBar();
    this->scrollBarZ_page2->setOrientation(Qt::Horizontal);
